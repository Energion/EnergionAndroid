...
public class CirclesView extends FrameLayout {
  public CirclesView(Context context, String time, String price, boolean lastItem) {
    super(context);

    init(time, price, lastItem);
  }
  ...
  private void init(String time, String price, boolean lastItem) {
